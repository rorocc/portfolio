<template>
  <div class="tocHelper z-100 m-auto my-8 h-0 overflow-visible sticky block relative max-w-prose top-12">
    <div class="toc">
      <div class="cursor-pointer py-2 px-4 flex justify-between border-b" @click="() => {this.isOpen = !isOpen}">
